...
<div class="container">
    ...
    <form action="updateAdmin.php" method="post">
        <div class="form-group row">
            ...
            <div class="col-md-10">
                <input type="email" name="email" class="form-control" readonly data-rule-required="true" id="email"
        ...
        <div class="form-group row">
            ...
            <div class="col-md-10">
                <input type="text" name="name" value="<?php echo $row["name"] ;?>" class="form-control" data-rule-required="true" id="name"
